            ...
            while (opcion !=5) {
                switch (opcion) {
                    case 1:
                        ...
                        double finalPrice = ProductCalculator.getPrice(price, utility);
                        System.out.println("╔══════════════════════════════════════════════════════════════════════════════════════════════════╗");
                        System.out.println("║ El precio al que deberías de vender tu producto es: " + finalPrice + " para generar una utilidad del " + utility + "║"); 
                        System.out.println("╚══════════════════════════════════════════════════════════════════════════════════════════════════╝");
                        break;
                    ...
                    case 2:
                        ...
                        while (cost < 0) {
                            try {
                                ...
                                if (cost < 0) {
                                    System.out.println("Error: El costo no puede ser negativo. Inténtalo de nuevo.");
                                }
                            } catch (NumberFormatException e) {
                                System.out.println("Error: Ingresa un número válido.");
                            }
